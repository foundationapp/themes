...
namespace Foundationapp\Themes;
...
class ThemesServiceProvider extends ServiceProvider
{
        ...
        try{
            ...
            if (Schema::hasTable('themes')) {
                $theme = $this->rescue(function () {
                    return \Foundationapp\Themes\Models\Theme::where('active', '=', 1)->first();
                });
                if(Cookie::get('theme')){
                    $theme_cookied = \Foundationapp\Themes\Models\Theme::where('folder', '=', Cookie::get('theme'))->first();
    ...
    {
        $namespacePrefix = '\\Foundationapp\\Themes\\Http\\Controllers\\';
